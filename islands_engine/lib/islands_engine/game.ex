...
defmodule IslandsEngine.Game do
  ...
  def demo_cast(game, test_value), do: GenServer.cast(game, {:demo_cast, test_value})
  ...
  def handle_cast({:demo_cast, new_value}, state),
    do: {:noreply, Map.put(state, :test, new_value)}

  def handle_call(:demo_call, _from, state), do: {:reply, state, state}
